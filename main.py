...
def custom_retriever_with_reranker(query, vectorstore, all_docs, reranker, fetch_k=15, top_k=3):
...
Extraction:"""
    ...
    while True:
        pergunta = input("\nFaça uma pergunta sobre o documento (ou 'sair'): ").strip()
        ...
        if not docs:
            print("\n[Resposta do Agente]: I could not find this information in the retrieved context.")
            continue
